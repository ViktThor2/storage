            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-Role">
                <thead>
                    <tr>
                        ...
                        <th class="align-middle">{{ trans('cruds.role.fields.id') }}</th>
                        <th class="align-middle">Szerepek</th>
                        <th class="align-middle">Jogosultságok</th>
                        <th width="240" class="align-middle"><a class="btn btn-success w-100" href="{{ route("admin.roles.create") }}">
                                {{ trans('global.add') }}
                            </a>
                        </th>
                    </tr>
