    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.assets.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" name="value" id="value" value="{{ $asset->value ?? '' }}" required>
            </div>
            ...
            <div class="form-group">
                <label class="required" for="critical_stock">Kritikus mennyiség</label>
                <input type="number" class="form-control" name="critical_stock" id="critical_stock" required>
            </div>
            ...
            <div class="form-group mt-2">
                ...
                <select class="form-control select2" name="subcategory" id="subcategory">
                    <option value=""  selected>Kérem válasszon kategóriát</option>
                    @foreach($categories as $category)
